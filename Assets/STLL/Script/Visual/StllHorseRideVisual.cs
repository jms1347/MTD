...
/// <summary>5분 버티기 CwslPlayerHorseRideVisual과 동일한 말·기수 갤럽 연출.</summary>
public class StllHorseRideVisual : MonoBehaviour
{
    ...
    private static void ApplyLegPose(Transform leg, Vector3 baseLocalPosition, float swing, float lift, float kick)
    {
        if (leg == null)
            return;
