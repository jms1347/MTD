...
public class CoopDangerZone : MonoBehaviour
{
    [SerializeField] private float cooldownSeconds = 22f;
    ...
    private void Awake()
    {
        ...
        trigger.size = new Vector3(2.6f, 1.4f, 2.6f);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        session.SetAnnouncement("위험 구역! 대규모 매복이 시작됩니다!");
    }
}
